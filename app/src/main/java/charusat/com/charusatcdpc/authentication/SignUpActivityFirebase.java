...
public class SignUpActivityFirebase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.factivity_signup);
        ...
        btnResetPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SignUpActivityFirebase.this, ResetPasswordActivity.class));
            }
        });
                        ...
                        .addOnCompleteListener(SignUpActivityFirebase.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    Toast.makeText(SignUpActivityFirebase.this, "Authentication failed." + task.getException(),
                                            Toast.LENGTH_SHORT).show();
                                } else {
                                    startActivity(new Intent(SignUpActivityFirebase.this, MainDashboard.class));
