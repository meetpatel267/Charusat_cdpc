...
import charusat.com.charusatcdpc.student.ViewCompanyDetails;
import charusat.com.charusatcdpc.student.ViewStudentDetails;

public class MainDashboard extends AppCompatActivity {

    ImageView img_add_personal_data;
    ImageView img_add_academic_data;
    ImageView img_student_view_details ;
    ImageView img_company_details ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       i = getIntent();
        ...
        img_student_view_details = (ImageView) findViewById(R.id.img_view_details);
        img_company_details = (ImageView) findViewById(R.id.img_company_details);
       ...
       /* DrawerLayout mDrawerlayout = (DrawerLayout) findViewById(R.id.drawer_layout);
        ...
        img_placement_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainDashboard.this,PlacementData.class);
        ...
        img_cdpc_activities.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myintent = new Intent(MainDashboard.this,CdpcActivities.class);
        ...
        img_add_personal_data.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myintent = new Intent(MainDashboard.this,PersonalData.class);
        ...
        img_add_academic_data.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myintent = new Intent(MainDashboard.this,AcademicData.class);
                String id = i.getStringExtra("id");
                myintent.putExtra("id",id);
                startActivity(myintent);
            }
        ...
        img_company_details.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myintent = new Intent(MainDashboard.this,ViewCompanyDetails.class);
                String id = i.getStringExtra("id");
                myintent.putExtra("id",id);
                startActivity(myintent);
            }
        ...
        img_student_view_details.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String id = i.getStringExtra("id");
                Intent myintent = new Intent(MainDashboard.this,ViewStudentDetails.class);
               myintent.putExtra("id",id);
                startActivity(myintent);
            }
        });
...
*/
        ...
        if (id == R.id.nav_logout) {
            ...
            Intent intent = new Intent(MainDashboard.this,LogoutActivity.class);
            startActivity(intent);
